...
Атрибуты:
- Запись (Record): Запись при изменении сущности
...
Действия:
- Очистить историю изменений (Delete Record) - стереть историю.
- Добавить запись (Create Record) - создается запись об изменении.
